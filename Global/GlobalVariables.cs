...
public class GlobalVariables
{
    public static Dictionary<string, int[]> spriteNumbers = new Dictionary<string, int[]> {
            ...
            { "rightJumpBigMario", new int[] { 0, 32, 16, 32, 1, 1, 3 } }, 
            { "rightRunBigMario", new int[] { 16, 32, 16, 32, 3, 1, 3 } },
            { "rightStandBigMario", new int[] { 64, 32, 16, 32, 1, 1, 3 } },
            { "rightCrouchBigMario", new int[] { 80, 32, 16, 22, 1, 1, 3 } },
            { "leftJumpBigMario", new int[] { 0, 64, 16, 32, 1, 1, 3 } },
            { "leftRunBigMario", new int[] { 16, 64, 16, 32, 3, 1, 3 } },
            { "leftStandBigMario", new int[] { 64, 64, 16, 32, 1, 1, 3 } },
            { "leftCrouchBigMario", new int[] { 80, 64, 16, 22, 1, 1, 3 } },
            ...
            { "rightCrouchFireMario", new int[] { 80, 96, 16, 22, 1, 1, 3 } },
            ...
            { "leftCrouchFireMario", new int[] { 80, 128, 16, 22, 1, 1, 3 } }
     };
}
